...
if os.path.exists(model_path):
    try:
        ...
        st.write("Aplikasoi ini digunakan untuk membantu memprediksi penyakit diabetes pada seseorang")
        ...
        if st.button("Prediksi!"):
            ...
            st.write(f"ORang tersebut diprediksu **{outcome_names[rf_model_prediction[0]]}** oleh RF")
